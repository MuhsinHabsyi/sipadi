...
-- Membuang struktur basisdata untuk sipadi
...
-- membuang struktur untuk table sipadi.alokasi_bibits
...
-- membuang struktur untuk table sipadi.anggota_petanis
CREATE TABLE IF NOT EXISTS `anggota_petanis` (
  ...
  `nama_lahan` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `alamat_lahan` text COLLATE utf8mb4_unicode_ci,
...
-- membuang struktur untuk table sipadi.arus_kas
...
-- membuang struktur untuk table sipadi.cache
...
-- membuang struktur untuk table sipadi.cache_locks
...
-- membuang struktur untuk table sipadi.data_panens
...
-- membuang struktur untuk table sipadi.failed_jobs
...
-- membuang struktur untuk table sipadi.jobs
...
-- membuang struktur untuk table sipadi.job_batches
...
-- membuang struktur untuk table sipadi.konten_landings
CREATE TABLE IF NOT EXISTS `konten_landings` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `judul_hero` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `deskripsi_hero` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `judul_toko` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `deskripsi_toko` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `produk_nama` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT 'Beras Pandan Wangi',
  `produk_deskripsi` text COLLATE utf8mb4_unicode_ci,
  `produk_harga` int DEFAULT '15000',
  `produk_stok_dijual` int DEFAULT '500',
...
-- membuang struktur untuk table sipadi.laporan_operasionals
...
-- membuang struktur untuk table sipadi.migrations
...
-- membuang struktur untuk table sipadi.password_reset_tokens
...
-- membuang struktur untuk table sipadi.pelanggans
...
-- membuang struktur untuk table sipadi.pembagian_hasils
...
-- membuang struktur untuk table sipadi.pengadaans
CREATE TABLE IF NOT EXISTS `pengadaans` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `jenis_barang` enum('Bibit','Pupuk') COLLATE utf8mb4_unicode_ci NOT NULL,
  `musim_tanam` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `asal_barang` enum('Beli','Dinas') COLLATE utf8mb4_unicode_ci NOT NULL,
  `jumlah` int NOT NULL,
  `harga` decimal(15,2) NOT NULL DEFAULT '0.00',
  `total_biaya` decimal(15,2) NOT NULL DEFAULT '0.00',
  `keadaan` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- membuang struktur untuk table sipadi.penggunas
...
-- membuang struktur untuk table sipadi.sessions
...
-- membuang struktur untuk table sipadi.stok_beras
CREATE TABLE IF NOT EXISTS `stok_beras` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `ketersediaan_stok` double NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `stok_ecommerce` double NOT NULL DEFAULT '0',
  `stok_distributor` double NOT NULL DEFAULT '0',
  `stok_gudang` double NOT NULL DEFAULT '0',
  `harga_per_kilo` decimal(12,2) NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Pengeluaran data tidak dipilih.

-- membuang struktur untuk table sipadi.transaksis
CREATE TABLE IF NOT EXISTS `transaksis` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `id_pelanggan` bigint unsigned DEFAULT NULL,
  `nama_pelanggan_manual` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `alamat_pengantaran` text COLLATE utf8mb4_unicode_ci,
  ...
  `tipe_transaksi` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ecommerce',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- membuang struktur untuk table sipadi.users
